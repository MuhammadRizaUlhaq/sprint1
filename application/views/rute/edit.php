      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>Tambah Costumer</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>Data Costumer</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i>Data Rute</a></li>
          </ul>
        </li>
        <li class="active treeview">
          ...
          <ul class=" treeview-menu">
            <li class="active"><a href="<?php echo site_url('admin/form'); ?>"><i class="fa fa-circle-o"></i>Tambah User</a></li>
            <li><a href="<?php echo site_url('admin/table'); ?>"><i class="fa fa-circle-o"></i>Data User</a></li>
          </ul>
        </li>
      </ul>
