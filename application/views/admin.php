        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Muhammad Riza Ulhaq</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Muhammad Riza Ulhaq - Web Developer
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Costumer</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('admin/tambah_costumer') ?>"><i class="fa fa-circle-o"></i>Tambah Costumer</a></li>
            <li><a href="<?php echo site_url('admin/lihat_costumer') ?>"><i class="fa fa-circle-o"></i>Data Costumer</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa ion-pie-graph"></i> <span>Rute</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('admin/tambah_rute') ?>"><i class="fa fa-circle-o"></i>Tambah Rute</a></li>
            <li><a href="<?php echo site_url('admin/lihat_rute') ?>"><i class="fa fa-circle-o"></i>Data Rute</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('admin/tambah_user') ?>"><i class="fa fa-circle-o"></i>Tambah User</a></li>
            <li><a href="<?php echo site_url('admin/lihat_user') ?>"><i class="fa fa-circle-o"></i>Data User</a></li>
          </ul>
        </li>
      </ul>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="<?php echo site_url('admin/lihat_user'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
